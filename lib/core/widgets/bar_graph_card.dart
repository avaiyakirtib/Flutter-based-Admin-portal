...
class BarGraphCard extends StatelessWidget {
  final List<BarGraphModel> data = [
    ...
    BarGraphModel(lable: "Chart 3", color: const Color(0xFF20AEF3), graph: [
      GraphModel(x: 0, y: 7),
      GraphModel(x: 1, y: 10),
      GraphModel(x: 2, y: 7),
      GraphModel(x: 3, y: 4),
    ...
    BarGraphModel(lable: "Chart 4", color: const Color(0xFF20EE5), graph: [
      GraphModel(x: 0, y: 7),
      GraphModel(x: 1, y: 10),
      GraphModel(x: 2, y: 7),
      GraphModel(x: 3, y: 4),
    ...
    BarGraphModel(lable: "Chart 5", color: Colors.pinkAccent, graph: [
      GraphModel(x: 0, y: 7),
      GraphModel(x: 1, y: 10),
      GraphModel(x: 2, y: 7),
      GraphModel(x: 3, y: 4),
    ...
    BarGraphModel(lable: "Chart 6", color: Colors.teal, graph: [
      GraphModel(x: 0, y: 7),
      GraphModel(x: 1, y: 10),
      GraphModel(x: 2, y: 7),
      GraphModel(x: 3, y: 4),
